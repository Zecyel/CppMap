...
<template>
  <div of-y-auto flex flex-col>
    <div v-for="no, i in num" :key="i" flex>
      <div select-none cursor-pointer hover:bg-gray-200 active:bg-gray-300 flex items-center justify-center w-8 min-h-8 text-lg text-gray-800 @click="toggle(no - 1)">
